...
if( !isset($_GET['token']) || !isset($_GET['thread']) ) {
	...
	if( !$thread ) {
		...
		if(!has_online_operators($groupid)) {
			$page = array();
			setup_logo();
			//echo("<strong>Sorry. None of the support team is available at the moment. <br/>Please check back soon OR email us <a href="mailto:support@hillsoft.com">Email Support</a></strong>");
