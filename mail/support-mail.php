...
$recipientEmail             = 'sales@hillsoft.com'; // REQUIRED value.
$recipientName              = 'HillsideSoftware Web Lead';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from HillsideSoftware.com'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'HillsideSoftware.com';                // REQUIRED value. This is used when a name or email is not collected from the website form
