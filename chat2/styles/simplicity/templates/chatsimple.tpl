...
<div id="greybg">
	...
	<table id="chat" cellpadding="0" cellspacing="5" border="0" width="100%">
		<tr>
			<td>
				<iframe id="chatwnd" class="chathistory" name="chatwndiframe" src="${mibewroot}/thread.php?act=refresh&amp;thread=${page:ct.chatThreadId}&amp;token=${page:ct.token}&amp;html=on&amp;user=true" frameborder="0">
