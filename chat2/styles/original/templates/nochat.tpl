...
<td>
	...
	</tr><tr><td height="100%" bgcolor="#FED840"><img src="${mibewroot}/images/free.gif" width="1" height="1" border="0" alt="" /></td>
	...
	</td><td bgcolor="#E8A400"><img src="${mibewroot}/images/free.gif" width="1" height="1" border="0" alt="" /></td>
	</tr><tr><td><img class="tplimage icrnlb" src="${mibewroot}/images/free.gif" border="0" alt=""/></td>
...
<td>
    ...
    <td width="100%" align="right">
		...
		<tr>
	    <td><a href="javascript:window.close();" title="${msg:page.chat.old_browser.close}"><img class="tplimage iback" src="${mibewroot}/images/free.gif" border="0" alt=""/></a></td>
	    <td width="5"></td>
