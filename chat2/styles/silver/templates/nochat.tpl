...
<body class="bgbody">
	...
	<div id="headers">
		<div class="wndb"><div class="wndl"><div class="wndr"><div class="wndt"><div class="wndtl"><div class="wndtr"><div class="wndbl"><div class="wndbr">
			<div class="buttons">
				<a href="javascript:window.close();" title="${msg:page.chat.old_browser.close}"><img class="tplimage iclosewin" src="${mibewroot}/images/free.gif" alt="${msg:page.chat.old_browser.close}" /></a>
			</div>
